...
def slap_cb(word, word_eol, userdata):
  ...
  items = ["your hero", "Apple", "Donald Trump's combover", "Lizard's food", "a FastLizard4", "Tintle's trollness", "MJ94's brain", "fish's food", "a dead forum", "NetOpsBot's trout", "1a 2r3a4i5n6b7o8w 9s10h11i12t", "JeDa's laptop", "your ass", "X-Chat v0.1 beta", "LuminolBlue's cat", "Wikipedia trolls", "a Beancounter's broken line", "a cursed [-1] Aperture Science Weighted Companion Cube", "a Sagittarius A*, the black hole at the center of the galaxy, with a talking Aperture Science Weighted Companion Cube", "an atomic diamond hoe", "an atomic whale", "Donald Trump's cursed [-1] combover", "a wolf", "a Werewolf's 15-player failgame", "a bridge with a cursed [-1] whale", "a feisty rolled-up comic", "a quantum fish", "Python", "a bug", "a SlowLizard8"]
  if len(word) > 1:
